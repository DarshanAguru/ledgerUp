...
const Page = () => {
    ...
    const { getAllIncomeCats } = useCategoryStore();

    const [categoriesData, setCategoryData] = useState<any>([]);

    useFocusEffect(useCallback(()=>{
        setCategoryData(getAllIncomeCats());
    }, []))
  ...
  />         
        ...
        <View style={{flex: 1}}/>
        <TouchableOpacity style={[defaultStyles.pillButton,(amount.trim() ==="" || category.trim() === "") ? styles.disabled:styles.enabled, {marginBottom: 20}]} onPress={onSave}>
